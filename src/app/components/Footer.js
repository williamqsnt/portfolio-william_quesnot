...
export default function Footer() {
    ...
    return (
        <footer className="bg-[#ECE7DF] text-white py-10">
            <div className="container mx-auto text-center lg:flex lg:justify-between lg:items-center">
                <div className="text-xl font-bold">
                    ...
                    <p className="font-light text-sm text-gray-900">The ability to bring your imagination <br /> to life is what makes a good developer. </p>
                </div>
                <div className="lg:flex space-x-10 items-center py-5">
                    <div className="text-white text-sm text-center lg:text-left">
                        ...
                        <ul className="list-inside">
                            {pages.map((page, index) => (
                                <li key={index}>
                                    <a href={page.link} className="text-gray-900 transition duration-300 ease-in-out">
                                        {page.title}
                                    </a>
                                </li>
                            ))}
                    ...
                    <div className="lg:flex lg:flex-col items-center">
                        <div className="text-gray-900 text-sm uppercase font-bold mb-2 hidden lg:block">Social</div> {/* Masquer sur les petits écrans */}
